...
add_spacer|small|
add_textbox|`9This Proxy Made By : `!YoshiGT|left|
add_spacer|small|
add_label_with_icon|small|`9I'M NOT RESPONSIBLE OF WHAT HAPPEN TO YOU IF YOU DOWNLOAD PROXY FROM OTHER SOURCES.|left|1432|
add_spacer|small|
add_label_with_icon|small|`9BUY PROXY ? DM `!YoshiGT.|left|1438|
add_spacer|small|
add_textbox|`9Facebook : `!Yoshi GT|left|
add_textbox|`9TikTok : `!@YoshiGT|left|
add_spacer|small|
add_textbox|`9Current CSN tax : (`3]]..settax_1..[[%`9)|left|
...
add_spacer|small|
add_smalltext|`9Command : `0/spin check or /sc `0( `3Real / Fake spin checker `0)|left|
...
add_smalltext|`9Command : `0/side right or /sr `0( `3Drop locks into right pos when dropping `0)|left|
add_smalltext|`9Command : `0/side left or /sl `0( `3Drop locks into left pos when dropping `0)|left|
...
add_spacer|small|
add_smalltext|`9Command : `0/spin check or /sc `0( `3check is spin real or fake `0)|left|
add_smalltext|`9Command : `0/spin qq `0( `3check qq spin `0)|left|
add_smalltext|`9Command : `0/spin reme `0( `3check reme spin `0)|left|
...
function cdrop_delayed()
    ...
    elseif wl_count < wl_to_drop then -- check if enough WLS to drop
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Dropping `3" ..wl_to_drop.. " `9wls and `3"..dl_to_drop.. " `9dls")
...
function add(type, packet)
    ...
    OnConsoleMessage("`0[ `3Yoshiro `0] `9Adding Item : `3"..GetIteminfo(add_item).name.." `9count : `3" ..add_count)
    local packet = {}
    packet.type = 13
...
function doorxxx(type, packet)
    ...
    OnConsoleMessage("`0[ `3Yoshiro `0] `9Joining door id : `3"..door_id)
...
function pos1(type, packet)
    if packet == ("action|input\n|text|/setpos1") or packet == ("action|input\n|text|/sp1") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9pos 1 set to `3"..x_pos1.." `9,`3"..y_pos1)
        local var = {}
...
function pos2(type, packet)
    if packet == ("action|input\n|text|/setpos2") or packet == ("action|input\n|text|/sp2") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9pos 2 set to `3"..x_pos2.." `9,`3"..y_pos2)
        local var = {}
        var[0] = "OnParticleEffect"
        var[1] = 354
        var[2] = { GetLocal().pos_x + 10, GetLocal().pos_y + 15}
...
function pos3(type, packet)
    if packet == ("action|input\n|text|/setpos3") or packet == ("action|input\n|text|/sp3") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9pos 3 set to `3"..x_pos3.." `9,`3"..y_pos3)
        local var = {}
        var[0] = "OnParticleEffect"
        var[1] = 354
        var[2] = { GetLocal().pos_x + 10, GetLocal().pos_y + 15}
...
function pos4(type, packet)
    if packet == ("action|input\n|text|/setpos4") or packet == ("action|input\n|text|/sp4") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9pos 4 set to `3"..x_pos4.." `9,`3"..y_pos4)
        local var = {}
        var[0] = "OnParticleEffect"
        var[1] = 354
        var[2] = { GetLocal().pos_x + 10, GetLocal().pos_y + 15}
...
function posback(type, packet)
    if packet == ("action|input\n|text|/setposback") or packet == ("action|input\n|text|/spb") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9host pos set to `3"..x_posback.." `9,`3"..y_posback)
        local var = {}
        var[0] = "OnParticleEffect"
        var[1] = 356
        var[2] = { GetLocal().pos_x + 10, GetLocal().pos_y + 15}
    ...
    if packet:find("action|input\n|text|/player ") then
        ...
        for _,playerx in ipairs(GetPlayers()) do
            if playerx.name:sub(3,-3) == player_name_tp then
                found = true
                OnConsoleMessage("`0[ `3Yoshiro `0] `9player found !")
                FindPath(playerx.pos_x / 32 , playerx.pos_y / 32)
        return true
            end
            if not found then
                OnConsoleMessage("`0[ `3Yoshiro `0] `9player `4NOT `9found")
            break 
            end
        end
        return true
...
function flagxx(type, packet)
    if packet:find("action|input\n|text|/flag ") then
        flagxxid = packet:gsub("action|input\n|text|/flag ", "")
            OnConsoleMessage("`0[ `3Yoshiro `0] `9changing flag to `3" ..flagxxid)
            var2 = {}
...
function random_world(type, packet)
    if packet == ("action|input\n|text|/rndm") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9warping to "..totTxt)
        SendPacket(3, "action|join_request\nname|" .. totTxt)
    return true
    end
end
...
function cid(type, packet)
    if packet == ("action|input\n|text|/cid") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Making new account..")
...
function res(type, packet)
    if packet == ("action|input\n|text|/res") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9respawning")
...
function info_commands(type, packet)
    if packet == ("action|input\n|text|/info") then
        ...
        if Spin_checker == true then
            Spin_checker_status = "`2Enabled"
        else 
            Spin_checker_status = "`4Disabled"
        end
...
function balance(type, packet)
    if packet == ("action|input\n|text|/balance") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9WL : `3"..wl_balance.." `1& `9DL : `3"..dl_balance.." `1& `9BGL : `3"..bgl_balance)
...
function relog(type, packet)
    if packet == ("action|input\n|text|/relog") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9reloging")
...
function Wrench_mode(type, packet)
    ...
    elseif packet:find("buttonClicked|wrench_off") then
        mode_wm = "off"
        OnConsoleMessage("`0[ `3Yoshiro `0] `9wrench mode is `3off")
...
function modfly(type, packet)
    if packet == ("action|input\n|text|/modfly") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9mod fly is now `3enabled")
        EditToggle("ModFly", true)
        mod_fly = true
        elseif mod_fly == true then
            OnConsoleMessage("`0[ `3Yoshiro `0] `9mod fly is now `3disabled")
    ...
    if packet == ("action|input\n|text|/vault") then
        for _,tile in pairs(GetTiles()) do
            if tile.fg == 8878 then
                ...
                OnConsoleMessage("`0[ `3Yoshiro `0] `9x pos set to : `3"..x_pos.." `0x `9y pos set to : `3"..y_pos)
                OnConsoleMessage("`0[ `3Yoshiro `0] `9Now wrench Storage Box then type /bypass")
                OnConsoleMessage("`0[ `3Yoshiro `0] `4NOTE : `9you MUST have atleast 1 Dirt Block.")
            end
        end
        return true
    end
...
function sccd1(type, packet)
    if packet == ("action|input\n|text|/sc") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9save set when joning world is `3enabled")
    ...
    save_set_modes = true
        elseif save_set_modes == true then
            OnConsoleMessage("`0[ `3Yoshiro `0] `9safe set when joning world is `3disabled")
...
function std1(type, packet)
    if packet == ("action|input\n|text|/st") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9save title when joning world is `3enabled")
...
save_title_modes = true
    elseif save_title_modes == true then
            OnConsoleMessage("`0[ `3Yoshiro `0] `9safe title when joning world is `3disabled")
...
function set_save_clothes(type, packet)
  if packet == ("action|input\n|text|/clothe") or packet == ("action|input\n|text|/clothes") then
    OnConsoleMessage("`0[ `3Yoshiro `0] `9Changing clothes")
    new_clothes()
    local var = {}
    var[0] = "OnParticleEffect"
    var[1] = 73
...
function start_stop_check_gems(type, packet)
    if packet == ("action|input\n|text|/bj") then
        if gems_checker then
            OnConsoleMessage("`0[ `3Yoshiro `0] `9BJ gems checker is `3off")
            gems_checker = false
           else
            OnConsoleMessage("`0[ `3Yoshiro `0] `9BJ gems checker is `3on")
            gems_checker = true
        end
           RunThread(function()
                   setgems()
...
function ve(type, packet)
    if packet == ("action|input\n|text|/ve") then
        vend_modexd = true
        OnConsoleMessage("`0[ `3Yoshiro `0] `9vend mode set to `3empty")
...
function va(type, packet)
    if packet == ("action|input\n|text|/va") then
        vend_modexd = true
        OnConsoleMessage("`0[ `3Yoshiro `0] `9vend mode set to `3add")
        function vend_mode(varlist)
            if varlist[0] == "OnDialogRequest" and varlist[1]:find("end_dialog|vending|Close|Update|") then
    ...
    if packet:find("action|input\n|text|/vb") then
        ...
        set_vb_123 = packet:gsub("action|input\n|text|/vb", "")
            set_vb = tonumber(set_vb_123)
                OnConsoleMessage("`0[ `3Yoshiro `0] `9Amount to buy : `3"..set_vb.."")
                vend_buy = true
                function vend_mode(varlist)
...
function voff(type, packet)
    if packet == ("action|input\n|text|/voff") then
        vend_modexd = false
        OnConsoleMessage("`0[ `3Yoshiro `0] `9vend mode is now `3off")
...
function start_stop_collect(type, packet)
    if packet == ("action|input\n|text|/autocollect") or packet == ("action|input\n|text|/ac") then
        if autocollect then
            OnConsoleMessage("`0[ `3Yoshiro `0] `9autocollect is `3off")
            autocollect = false
           else
            OnConsoleMessage("`0[ `3Yoshiro `0] `9autocollect is `3on")
            autocollect = true
        end
           RunThread(function()
                   setcollect()
...
function ut_adder_hook(type, packet)
    if packet == ("action|input\n|text|/ut add") or packet == ("action|input\n|text|/ua") then
        ...
        if ut_emptier_mode then
            ...
            ut_adder_mode = true
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast UT adder `3enabled")
            RemoveCallback("UT_mode3")
            RemoveCallback("UT_mode4")
            AddCallback("UT_mode1", "OnVarlist", UT_mode1)
            AddCallback("UT_mode2", "OnVarlist", UT_mode2)
...
function ut_emptier_hook(type, packet)
    if packet == ("action|input\n|text|/ut empty") or packet == ("action|input\n|text|/ue") then
        ...
        if ut_adder_mode then
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast UT emptier `3enabled")
            AddCallback("UT_mode3", "OnVarlist", UT_mode3)
            AddCallback("UT_mode4", "OnVarlist", UT_mode4)
            return true
        end
...
function ut_on_off(type, packet)
    if packet == ("action|input\n|text|/ut off") or packet == ("action|input\n|text|/uoff") then
        ut_of_or_no = false
        OnConsoleMessage("`0[ `3Yoshiro `0] `9UT mode is now `3off")
        if ut_adder_mode then
        RemoveCallback("UT_mode1")
        RemoveCallback("UT_mode2")
        ut_adder_mode = false
...
function gaia_adder_hook(type, packet)
    if packet == ("action|input\n|text|/gaia add") or packet == ("action|input\n|text|/ga") then
        ...
        if gaia_emptier_mode then
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast GAIA adder `3enabled")
            RemoveCallback("UT_mode3")
            RemoveCallback("UT_mode4")
            AddCallback("GAIA_mode1", "OnVarlist", GAIA_mode1)
            AddCallback("GAIA_mode2", "OnVarlist", GAIA_mode2)
...
function gaia_emptier_hook(type, packet)
    if packet == ("action|input\n|text|/gaia empty") or packet == ("action|input\n|text|/ge") then
        ...
        if gaia_adder_mode then
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast GAIA emptier `3enabled")
            AddCallback("GAIA_mode3", "OnVarlist", GAIA_mode3)
            AddCallback("GAIA_mode4", "OnVarlist", GAIA_mode4)
            return true
        end
...
function gaia_on_off(type, packet)
    if packet == ("action|input\n|text|/gaia off") or packet == ("action|input\n|text|/goff") then
        gaia_of_or_no = false
        OnConsoleMessage("`0[ `3Yoshiro `0] `9GAIA mode is now `3off")
        if gaia_adder_mode then
        RemoveCallback("UT_mode1")
        RemoveCallback("UT_mode2")
        gaia_adder_mode = false
...
function auto_put_donationbox_hook_xd(type, packet)
    if packet == ("action|input\n|text|/donation add") or packet == ("action|input\n|text|/da") then
        if auto_put_donationbox_mode == true then
            ...
            auto_put_donationbox_mode = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast empty donation `3disabled")
        elseif auto_put_donationbox_mode == false then
            mode_donation_boxes = "Donation_Add"
            auto_empty_donationbox_mode = false
            auto_put_donationbox_mode = true
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast empty donation `3enabled")
        end
    return true
end
end
...
function donationoff(type, packet)
    if packet == ("action|input\n|text|/donation off") or packet == ("action|input\n|text|/doff") then
        ...
        auto_empty_donationbox_mode = false
        auto_put_donationbox_mode = false
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Donation Box mode is now `3disabled")
        return true
    end
end
    ...
    if auto_ban_fire_maker_mode then
        function fireban(v)
            if v[0] == "OnTalkBubble" and v[2]:find("`4MWAHAHAHA!!") then
                netid = v[1]
                OnConsoleMessage("`0[ `3Yoshiro `0] `9Player with a netid of `3"..netid.." `9placed a pocket lighter !")
                pkt = [[action|wrench
                |netid|]]..netid
...
function auto_ban_fire_maker_hook_xd(type, packet)
    if packet == ("action|input\n|text|/fire ban") then
        if auto_ban_fire_maker_mode == true then
            auto_ban_fire_maker_mode = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9auto ban fire maker `3disabled")
        RemoveCallback("fire")
        elseif auto_ban_fire_maker_mode == false then
            auto_ban_fire_maker_mode = true
            OnConsoleMessage("`0[ `3Yoshiro `0] `9auto ban fire maker `3enabled")
...
function fd_hook_xd(type, packet)
    if packet == ("action|input\n|text|/fd") then
        if fd_mode == true then
            fd_mode = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast drop `3disabled")
        RemoveCallback("fd")
        elseif fd_mode == false then
            fd_mode = true
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast drop `3enabled")
        AddCallback("fd","OnVarlist", fd)
        end
    return true
end
...
function ft_hook_xd(type, packet)
    if packet == ("action|input\n|text|/ft") then
        if ft_mode == true then
            ft_mode = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast trash `3disabled")
        RemoveCallback("ft")
        elseif ft_mode == false then
            ft_mode = true
            OnConsoleMessage("`0[ `3Yoshiro `0] `9fast trash `3enabled")
        AddCallback("ft","OnVarlist", ft)
        end
    return true
end
...
function setbuywl()
    ...
    amount = amount_gems_round
        while buying_wls do
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Buying `3" ..amount.. " `9wls")
            while amount~=0 do
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Done")
            buying_wls = false
		end
end
...
function start_stop_buywls(type, packet)
    if packet == ("action|input\n|text|/buywl") then
        if buying_wls then
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Buying wls is `3on")
            buying_wls = true
        end
           RunThread(function()
                   setbuywl()
...
function spinall(type, packet)
    if packet == ("action|input\n|text|/spinall") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Spinning all wheels")
...
function auto_crime(type, packet)
    if packet == ("action|input\n|text|/autocrime") or packet == ("action|input\n|text|/autoc") then
        if autocrime then
            autocrime = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Auto-crime `3Stopped")
            RemoveCallback("crime")
        return true
        else
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Auto-crime `3Started")
            autocrime = true
            function crime(var)
                if var[0]:find("OnDialogRequest") then
                    ...
                    if var[1]:find("|Battle%!|")  then
                        ...
                        OnConsoleMessage("`0[ `3Yoshiro `0] `9Villian : `3" .. var[1]:match("add_textbox|(.*)`` is"))
...
function auto_surg_helper(type, packet)
    if packet == ("action|input\n|text|/autosurghelper") or packet == ("action|input\n|text|/autosh") then
        if autosurghelper then
            autosurghelper = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Auto-surg Helper `3Stopped")
            RemoveCallback("surg")
            if hide_surg == true then
                RemoveCallback("hide_surg")
                end
...
tool = ""
itool = 0
OnConsoleMessage("`0[ `3Yoshiro `0] `9Auto-surg Helper `3Started")
function auto()
   if tool == "Sponge" then
      itool = 1258
   elseif tool == "Splint" then
...
function auto_startopia(type, packet)
    if packet == ("action|input\n|text|/autostartopia") or packet == ("action|input\n|text|/autost") then
        if autostartopia then
            autostartopia = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Auto-startopia `3Stopped")
...
step = 0
Mission = 0
OnConsoleMessage("`0[ `3Yoshiro `0] `9Auto-startopia `3Started")

function Drone()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6532")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Tactical Drone")
	Sleep(50)
end

function Teleporter()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6526")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Teleporter Charge")
	Sleep(50)
end

function Doc()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6534")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Stellar Documents")
	Sleep(50)
end

function Scan()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6530")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Quadriscanner")
	Sleep(50)
end

function Torp()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6540")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Growton Torpedo")
	Sleep(50)
end

function Dip()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6538")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Cyborg Diplomat")
	Sleep(50)
end

function Sup()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6536")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Star Supplies")
	Sleep(50)
end

function Giga()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6528")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Gigablaster")
	Sleep(50)
end

function Shield()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6518")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9HyperShields")
	Sleep(50)
end

function AI()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6520")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9AI Brain")
	Sleep(50)
end

function Gala()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6522")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Galactibolt")
	Sleep(50)
end

function Meds()
	SendPacket(2, "action|dialog_return\ndialog_name|startopia\nbuttonClicked|tool6524")
	OnConsoleMessage("`0[ `3Yoshiro `0] `9Space Meds")
	Sleep(50)
end
   ...
   if var[0] == "OnDialogRequest" and var[1]:find("end_dialog|startopia") and var[1]:find("Health") then
      if var[1]:find("add_label_with_icon|big|`w(%w+) Data") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3" .. var[1]:match("add_label_with_icon|big|`w(%w+) Data") .. " Data")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wSet a Course") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Set a Course")
            end
            Drone()
            return true
         end
         ...
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            if Mission == 0 then
               if var[1]:find("Outpost Attack") then
                  OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Outpost Attack")
               elseif var[1]:find("One Angry Ship") then
                  OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3One Angry Ship")
               end
            end
            Drone()
            return true
      ...
      elseif var[1]:find("add_label_with_icon|big|`wStarachnid Attack") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Starachnid Attack")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`w(%w+) Attack") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3" .. var[1]:match("add_label_with_icon|big|`w(%w+) Attack") .. " Attack")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wLife Pod") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Life Pod")
            end
            Teleporter()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wBoarding Party") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Boarding Party")
            end
            Scan()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wExperimental Salvage") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Experimental Salvage")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wDark Ship") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Dark Ship")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`w(%w+) Hunt") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3" .. var[1]:match("add_label_with_icon|big|`w(%w+) Hunt") .. " Hunt")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wWindy Days") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Windy Days")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wAncient Temple") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Ancient Temple")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wA Challenge") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3A Challenge?!")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wMiner Rescue") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Miner Rescue")
            end
            Gala()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wHunter and Prey") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Hunter and Prey")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wGiant Skeleton") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Giant Skeleton")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wShadow Stalkers") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Shadow Stalkers")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wPlanet Calamity") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Planet Calamity")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wA Strange One") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3A Strange One")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wTasty Cakes") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Tasty Cakes")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wTaking Aim") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Taking Aim")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wBad Taste") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Bad Taste")
            end
            Teleporter()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wSolar Impact!") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Solar Impact!")
            end
            Shield()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wJunk Punks") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Junk Punks")
            end
            AI()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wCryonite Crisis") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Cryonite Crisis")
            end
            Teleporter()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wSalvage Run") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Salvage Run")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wShip Rescue") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Ship Rescue")
            end
            Gala()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wSkeleton Crew") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Skeleton Crew")
            end
            Teleporter()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wGhost Ship") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Ghost Ship")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wPit o' Trouble") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Pit o' Trouble")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wClose Encounter") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Close Encounter")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wEscape Pod") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Escape Pod")
            end
            Meds()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wPrevent War") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Prevent War")
            end
            Shield()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wMining Colony Rescue") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Mining Colony Rescue")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wMining Colony Delivery") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Mining Colony Delivery")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`w(%w+) Duel") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3" .. var[1]:match("add_label_with_icon|big|`w(%w+) Duel") .. " Duel")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`wMining Colony Delivery") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3".. var[1]:match("add_label_with_icon|big|`w(%w.-) Extermination").. " Extermination")
            end
            Drone()
            return true
         end
      elseif var[1]:find("add_label_with_icon|big|`w(%w.-) Delivery") then
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            step = 0
            if Mission == 0 then
               OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3".. var[1]:match("add_label_with_icon|big|`w(%w.-) Delivery").. " Delivery")
            end
            Drone()
            return true
         end
         ...
         if var[1]:find("Skill Success") or var[1]:find("Skill Fail") then
            ...
            if Mission == 0 then
               if var[1]:find("|`wWho's There") then
                  OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3Who's There?")
               else
                  OnConsoleMessage("`0[ `3Yoshiro `0] `9Mission : `3She's Gonna Blow!")
               end
            end
            Drone()
            return true
...
function gemsx(type, packet)
    if packet == ("action|input\n|text|/gems") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9counting gems..")
        count = 0
        for _, obj in pairs(GetObjects()) do
        if obj.id == 112  then
...
function tax(type, packet)
    if packet:find("action|input\n|text|/tax") then
        tax_1_1 = packet:gsub("action|input\n|text|/tax", "")
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9amount to drop : `3"..tax_1_1 - real_tax)
            OnConsoleMessage("`0[ `3Yoshiro `0] `9amount to keep : `3"..real_tax)
            var2 = {}
            var2[0] = "OnTextOverlay"
...
function dropallxd()
    OnConsoleMessage("`0[ `3Yoshiro `0] `9dropping all items..")
    for k,v in ipairs(GetInventory()) do
        SendPacket(2 ,"action|drop\n|itemID|"..v.id)
        SendPacket(2 ,"action|dialog_return\ndialog_name|drop_item\nitemID|"..v.id.."|\ncount|"..v.count)
        Sleep(50)
    end
    OnConsoleMessage("`0[ `3Yoshiro `0] `9`9dropped all items")
end
    ...
    if packet:find("action|input\n|text|/harvestid") then
        set_harvest_id123 = packet:gsub("action|input\n|text|/harvestid", "")
            ...
            if (set_harvest_id123 % 2 ~= 0) then
                ...
                OnConsoleMessage("`0[ `3Yoshiro `0] `9harvest id set to : `3"..GetIteminfo(set_harvest_id).name)
                return true
            else
                OnConsoleMessage("`0[ `3Yoshiro `0] `9seed id must be a odd number !")
            return true
        end
    end
end
    ...
    if packet:find("action|input\n|text|/harvestdelay") then
        set_harvest_delay123 = packet:gsub("action|input\n|text|/harvestdelay", "")
            ...
            set_harvest_delay = tonumber(set_harvest_delay123)
                OnConsoleMessage("`0[ `3Yoshiro `0] `9harvest delay set to : `3"..set_harvest_delay.." `9Mili-Seconds ")
                return true
            else
                OnConsoleMessage("`0[ `3Yoshiro `0] `9delay cant be less than 150 !")
            return true
        end
    end
end
...
function start_stop_harvest(type, packet)
        if packet == ("action|input\n|text|/hv") then
            if harvesting then
                OnConsoleMessage("`0[ `3Yoshiro `0] `9harvest is `3off")
                harvesting = false
               else
                OnConsoleMessage("`0[ `3Yoshiro `0] `9harvest is `3on")
                harvesting = true
            end
               RunThread(function()
                       setharvest()
...
function inv(type, packet)
    if packet == ("action|input\n|text|/inv") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9redcuing lag..")
        for _,player in pairs(GetPlayers()) do
            var2 = {}
            var2[0] = "OnSetClothing"
            var2[1] =  {0,0,0}
...
function weatherlol(type, packet)
    if packet == ("action|input\n|text|/weather") then
        ...
        var.netid = -1
        SendVarlist(var)
        OnConsoleMessage("`0[ `3Yoshiro `0] `9changing weather value to : `3"..x)
    return true
    end
end
...
function guildxx(type, packet)
    if packet:find("action|input\n|text|/guild ") then
        guildxxid = packet:gsub("action|input\n|text|/guild ", "")
            OnConsoleMessage("`0[ `3Yoshiro `0] `9changing guild to `3" ..guildxxid)
...
function cahngenamexx(type, packet)
    if packet:find("action|input\n|text|/name ") then
        cahngenamexx1 = packet:gsub("action|input\n|text|/name ", "")
          ...
          OnConsoleMessage("`0[ `3Yoshiro `0] `9name changed to `9"..cahnge_name.."")
          var = {}
          var[0] = "OnNameChanged"
          var[1] = cahnge_name
          var.netid = GetLocal().netid
...
OnConsoleMessage("`0[ `3Yoshiro `0] `9this command is turned off")
end
return true
end
end
...
function blink_main(type, packet)
        if packet == ("action|input\n|text|/blink") then
            if blinking then
                OnConsoleMessage("`0[ `3Yoshiro `0] `9blink mode is `3off")
                blinking = false
               else 
                OnConsoleMessage("`0[ `3Yoshiro `0] `9blink mode is `3on")
                blinking = true
               end
...
function collectrangex(type, packet)
    if packet:find("action|input\n|text|/ccollect ") then
        collect_range = packet:gsub("action|input\n|text|/ccollect ", "")
          OnConsoleMessage("`0[ `3Yoshiro `0] `9Collenting items in `3" ..collect_range.. " `9range")
          function collectItems(range, delay, ispos)
            if not ispos then
...
function extactoreh1(type, packet)
    if packet:find("action|input\n|text|/pickup ") then
        pick_up_id = packet:gsub("action|input\n|text|/pickup ", "")
                ...
                OnConsoleMessage("`0[ `3Yoshiro `0] `9only picking `3"..pick_up_id)
                ID_TBL={
                    [pick_up_id]=1,
                    }
...
function no_pickup(type, packet)
    if packet == ("action|input\n|text|/nopickup") then
        if nopickup then
            nopickup = false
            OnConsoleMessage("`0[ `3Yoshiro `0] `9No pick-up turned `3off")
            RemoveCallback("pickup12")
        return true
        else
            OnConsoleMessage("`0[ `3Yoshiro `0] `9No pick-up turned `3on")
...
function autocollect_thread()
    OnConsoleMessage("`0[ `3Yoshiro `0] `9Collecting")
...
function showxy(type, packet)
    if packet == ("action|input\n|text|/xy") then
        ...
        OnConsoleMessage("`0[ `3Yoshiro `0] `9X : `3" ..x_pos_lols.. " `9Y `3:" ..y_pos_lols.."")
...
function ping(type, packet)
    if packet == ("action|input\n|text|/ping") then
        if GetPing() > 150 then
            ...
            OnConsoleMessage("`0[ `3Yoshiro `0] `9Your ping is : "..color..""..math.floor((GetPing())))
    return true
    end
end
...
function hidenname(type, packet)
    if packet == ("action|input\n|text|/hide") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9hiding all players names")
        for _,player in pairs(GetPlayers()) do
            GetLocal().name = GetLocal().name:removeColors()
            GetLocal().name = GetLocal().name:gsub(" of Legend", "")
            GetLocal().name = GetLocal().name:gsub("Dr.", "")
...
function growscan_mode(type, packet)
    if packet:find("buttonClicked|placed_gs") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Scaning placed blocks")
        function round(n)
...
SendVarlist(varlist)
    ...
    elseif packet:find("buttonClicked|float_gs") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Scaning dropped items")
        function round(n)
            return n % 1 >= 0.5 and math.ceil(n) or math.floor(n)
        end
...
function fc(type, packet)
    if packet == ("action|input\n|text|/fc") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Closing proxy.")
        RemoveCallbacks()
    return true
    end
end
...
function all_spin(type, packet)
    if packet == ("action|input\n|text|/spin all") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Spin mode set to `3QQ & REME")
...
function qq_spin(type, packet)
    if packet == ("action|input\n|text|/spin qq") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Spin mode set to `3QQ")
function Spin_checker(varlist)
    if varlist[0] == "OnTalkBubble" and varlist[3] ~= -1 and varlist[2]:find("spun the wheel and got") then
      text = ""
      if varlist[2]:find("CP:") then
...
function reme_spin(type, packet)
    if packet == ("action|input\n|text|/spin reme") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Spin mode set to `3REME")
function Spin_checker(varlist)
    if varlist[0] == "OnTalkBubble" and varlist[3] ~= -1 and varlist[2]:find("spun the wheel and got") then
      text = ""
      if varlist[2]:find("CP:") then
...
function check_spin(type, packet)
    if packet == ("action|input\n|text|/spin check") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Spin mode set to `3Checker")
function Spin_checker(varlist)
    if varlist[0] == "OnTalkBubble" and varlist[3] ~= -1 and varlist[2]:find("spun the wheel and got") then
      text = ""
      if varlist[2]:find("CP:") then
...
function visual_spin_2(type, packet)
    if packet:find("action|input\n|text|/visualspin ") then
        spin_nmber = packet:gsub("action|input\n|text|/visualspin ", "")
          ...
          OnConsoleMessage("`0[ `3Yoshiro `0] `9Visual spin set to `3"..spin_nmber)
...
function logingxd(type, packet)
	if packet:find("action|enter_game") then
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Removing game freeze / crash..")
...
function check_login(varlist)
    if varlist[0] == "OnConsoleMessage" and varlist[1]:find("Welcome back,") then
        ...
        dl_balance = math.floor(GetItemCount(1796))
        bgl_balance = math.floor(GetItemCount(7188))
        OnConsoleMessage("`0[ `3Yoshiro `0] `9Player Authentication `2Successful.")
        OnConsoleMessage("`0[ `3Yoshiro `0] `9WL : `3"..wl_balance.." `1& `9DL : `3"..dl_balance.." `1& `9BGL : `3"..bgl_balance)
        return true
    end
end
